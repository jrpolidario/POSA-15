        ...
        final Runnable downloadImageAndReply = 
            new Runnable() {
                ...
                public void run() {
                    ...
                    final Uri downloadedImagePath = Utils.downloadImage(mService.get().getApplicationContext(), imageUrl, directoryPathname);
                    ...
                    sendPath(replyMessenger, downloadedImagePath, imageUrl, requestCode);
                }
            };

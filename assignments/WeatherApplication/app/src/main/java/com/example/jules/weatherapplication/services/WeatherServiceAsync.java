 ...
 *        AIDL interfaces.
 */
public class WeatherServiceAsync extends WeatherServiceCached {
    /**
            ...
            new WeatherRequest.Stub() {
                ...
                public void getCurrentWeather(String location,
                    ...
                    if (weatherResults != null) {
                        ...
                        Log.d(TAG, "Cannot get current weather for " + location);
                        callback.sendResults(new ArrayList<WeatherData>()); //send empty list
                    }
                }
            };
}

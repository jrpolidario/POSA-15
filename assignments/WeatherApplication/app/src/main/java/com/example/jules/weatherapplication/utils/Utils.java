...
import com.example.jules.weatherapplication.jsonweather.WeatherJSONParser;
    ...
    public static List<WeatherData> getResults(final String location) {
        ...
        if (jsonWeathers != null && jsonWeathers.size() > 0) {
            ...
            for (JsonWeather jsonWeather : jsonWeathers)
                if (jsonWeather != null && jsonWeather.getWind() != null && jsonWeather.getMain() != null && jsonWeather.getSys() != null) {
